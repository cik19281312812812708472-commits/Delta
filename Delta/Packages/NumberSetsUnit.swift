...
class NumberSetsUnit: Package, ObservableObject, Codable {
    ...
    var numberOfQuestionsMadePerSection: Int = 12
    var allChangbleInts: [intSetting] = [intSetting(int: 12, name: "Number of questions per section")]
    ...
    enum allQuestions: String, CaseIterable {
        ...
        var answer: String {
            ...
            case .symbolIrrational: return "Q'"
